  ...
  return (
    <div className='relative bg-black  text-white lg:h-screen flex  justify-center items-center overflow-hidden'>
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/solutions/bg-3.png')`,
        }}
      ></div>
      ...
      <div className='relative z-10 flex flex-col gap-y-3 justify-center items-center py-20 lg:py-0 '>
        <h2 className='lg:text-7xl text-3xl font-sans font-medium text-center capitalize lg:leading-16 leading-10'>Outsourced Support, <br /> In-House Feel</h2>
